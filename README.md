# SEMI-E62_Loadplate_GenLayout
Auto LISP to generates layout

2D AUTOCAD file, attempts to build drawing and LISP programming.  
this is very old archived file or design prior to year 2005.  

### The result and plot
![GenLayout.lsp.jpg](GenLayout.lsp.jpg)  
plot file, [loadplate_fixture_layout340x394.4_420x350.1.pdf](loadplate_fixture_layout340x394.4_420x350.1.pdf)  
source code [GENLAYOUT.lsp](GENLAYOUT.lsp)  
